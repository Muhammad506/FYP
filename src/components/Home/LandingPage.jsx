const LandingPage = () => {
  return (
    <main className="relative text-white overflow-hidden ">
      ...
      {/* Content */}
      <div className="relative z-10 animate-slideInLeft flex flex-col items-start justify-center text-left space-y-6 sm:space-y-8 py-24 sm:py-40 px-8 sm:px-16 max-w-screen-lg mx-auto">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight drop-shadow-lg">
          Solar Intelli Solutions
        </h1>
        <p className="text-base sm:text-lg max-w-lg lg:max-w-2xl drop-shadow-md">
        ...
        <div className="w-full sm:w-auto">
          <button className="bg-gradient-to-r from-yellow-400 to-yellow-600 text-gray-800 rounded-3xl text-base px-6 py-3 font-bold transition-all duration-300 hover:from-yellow-500 hover:to-yellow-700 transform hover:scale-105 shadow-lg hover:shadow-xl ">
