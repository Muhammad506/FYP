    ...
    <main className="relative">
      ...
      >
        <div className="space-y-4 py-14 w-full text-white px-4 lg:px-0">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold p-3 lg:p-0">
            Features
          </h1>
        ...
        <div className="grid grid-cols-2 text-white sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 px-4 md:px-8">
